...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/chats/:chatId", rt.authMiddleware(rt.setGroupName))
	rt.router.PUT("/chats/:chatId/image", rt.authMiddleware(rt.setGroupPhoto))
	rt.router.POST("/chats/:chatId/members", rt.authMiddleware(rt.addToGroup))
	rt.router.DELETE("/chats/:chatId/members", rt.authMiddleware(rt.LeaveGroup))
	rt.router.POST("/chats/:chatId/messages", rt.authMiddleware(rt.sendMessage))
